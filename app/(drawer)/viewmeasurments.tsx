          ...
          {filteredMeasurements.map((item: Measurement, index: number) => (
            <View key={item._id || index} style={styles.card}>
              ...
              <View style={styles.badgeRow}>
                {[
                 { label: "سینہ", value: item.Chest, color: "#16a34a" },
  { label: "کمر", value: item.Waist, color: "#2563eb" },
  { label: "لمبائی", value: item.Length, color: "#9333ea" },
  { label: "کولہے", value: item.Hips, color: "#f59e0b" },
  { label: "کندھا", value: item.Shoulder, color: "#dc2626" },
  { label: "آستین", value: item.Sleeve, color: "#0891b2" },
  { label: "بازو", value: item.Bicep, color: "#65a30d" },
  { label: "کلائی", value: item.Wrist, color: "#7c3aed" },
  { label: "گردن", value: item.Neck, color: "#d946ef" },
  { label: "آرم ہول", value: item.Armhole, color: "#ea580c" },
  { label: "پاجامہ کمر", value: item.TrouserWaist, color: "#0d9488" },
  { label: "پاجامہ لمبائی", value: item.TrouserLength, color: "#4f46e5" },
  { label: "ران", value: item.Thigh, color: "#15803d" },
  { label: "گھٹنا", value: item.Knee, color: "#c026d3" },
  { label: "باٹم", value: item.Bottom, color: "#ca8a04" },
  { label: "انسیم", value: item.Inseam, color: "#2563eb" },
  { label: "رائز", value: item.Rise, color: "#dc2626" },
  { label: "ویسٹ کوٹ لمبائی", value: item.WaistcoatLength, color: "#16a34a" },
                ].map((field, i) => (
